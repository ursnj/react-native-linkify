...
var Linkify = /*#__PURE__*/function (_Component) {
  _inherits(Linkify, _Component);
  ...
  function Linkify(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "linkify", function (component) {
      ...
      try {
        _this.state.linkifyIt.tlds('app', true).match(component.props.children).forEach(function (_ref) {
...
Linkify.propTypes = {
  ...
  linkStyle: _propTypes["default"].shape(_reactNative.TextStyle),
...
Linkify.getDerivedStateFromProps = function (nextProps, prevState) {
...
var _default = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      if (this.props.linkDefault) return /*#__PURE__*/_react["default"].createElement(Linkify, _extends({}, this.props, {
        onPress: onPress
      }));
      return /*#__PURE__*/_react["default"].createElement(Linkify, this.props);
    }
  }]);
