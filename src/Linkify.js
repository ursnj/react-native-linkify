...
Linkify.propTypes = {
  ...
  linkStyle: PropTypes.shape(TextStyle),
...
Linkify.defaultProps = { linkify, injectViewProps: i => ({}) }

Linkify.getDerivedStateFromProps = (nextProps, prevState) => (nextProps.linkify !== prevState.linkifyIt)
...
export default class extends Component {
  ...
  render () {
    ...
    if (this.props.linkDefault)
      return <Linkify { ...this.props } onPress={ onPress }/>
    return <Linkify { ...this.props } />
  }
}
